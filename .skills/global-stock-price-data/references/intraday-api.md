...
**Endpoint:** `GET https://app-c6msorm02rk1-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday`
...
async function getIntradayData(symbol: string, params: IntradayParams = {}): Promise<IntradayResponse> {
  ...
  const response = await fetch(
    `https://app-c6msorm02rk1-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday?${query.toString()}`,
