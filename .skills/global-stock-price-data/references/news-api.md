...
**Endpoint:** `GET https://app-c6msorm02rk1-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-c6msorm02rk1-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
