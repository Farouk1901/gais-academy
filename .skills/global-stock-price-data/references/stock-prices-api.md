...
**Endpoint:** `GET https://app-c6msorm02rk1-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote`
...
async function getStockPrices(
  ...
  const response = await fetch(
    `https://app-c6msorm02rk1-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote?${query.toString()}`,
