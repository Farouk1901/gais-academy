...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-c6msorm02rk1-api-Xa6JZq2055oa.gateway.appmedo.com/search` |
...
```json
{
  ...
  "pagination": {
    "current": 1,
    "next": "https://app-c6msorm02rk1-api-Xa6JZq2055oa.gateway.appmedo.com/search?start=10"
  }
}
```
...
async function searchGoogleScholar(params: ScholarSearchParams): Promise<ScholarResponse> {
  ...
  const response = await fetch(
    `https://app-c6msorm02rk1-api-Xa6JZq2055oa.gateway.appmedo.com/search?${queryParams.toString()}`,
    {
      method: "GET",
      headers: {
