...
|-------|-------|
| Method | `POST` |
| URL | `https://app-c6msorm02rk1-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task` |
...
async function queryTask(taskId: string): Promise<TaskResult> {
  const response = await fetch(
    "https://app-c6msorm02rk1-api-GYX1lzGw0DQa.gateway.appmedo.com/image-generation/task",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
