...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-c6msorm02rk1-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
| HTTP Method | `GET` |
...
async function queryTask(taskId: string): Promise<QueryTaskResult> {
  const response = await fetch(
    `https://app-c6msorm02rk1-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
