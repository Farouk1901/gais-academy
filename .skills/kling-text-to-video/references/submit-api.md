...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-c6msorm02rk1-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| HTTP Method | `POST` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-c6msorm02rk1-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video",
    {
      method: "POST",
      headers: {
