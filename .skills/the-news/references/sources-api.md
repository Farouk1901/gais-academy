...
**Endpoint:** `GET https://app-c6msorm02rk1-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources`
...
async function getSources(params: SourcesParams = {}): Promise<SourcesResponse> {
  ...
  const response = await fetch(
    `https://app-c6msorm02rk1-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
