...
- **Endpoint**: `GET https://app-c6msorm02rk1-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart`
...
async function callWebSearch(
  ...
  const response = await fetch(
    `https://app-c6msorm02rk1-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart?${params.toString()}`,
    {
      method: "GET",
      headers: {
