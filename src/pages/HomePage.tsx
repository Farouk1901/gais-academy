            ...
            <Card key={`${t.name}-${active}-${i}`} className="h-full flex flex-col group hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-3">
              <CardContent className="p-6 flex flex-col gap-4 h-full">
                ...
                <div className="pt-4 border-t border-border/50 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary/20 to-primary/20 flex items-center justify-center shrink-0">
    ...
    <div className="min-h-screen bg-background text-foreground" dir="rtl">
      ...
      <section className="relative overflow-hidden min-h-[92vh] flex items-center">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-primary/6 rounded-full blur-3xl" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-10">
                <Link to="/courses">
                  <Button size="lg" className="gap-2 w-full sm:w-auto px-8 text-base bg-primary hover:bg-primary/90 text-white border-0 rounded-xl shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { label: 'كورس متاح', value: loading ? null : String(stats.courses), icon: BookOpen, color: 'text-primary' },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 relative">
            ...
            {[
              ...
              { num: '٢', title: 'اختر الكورس',   desc: 'تصفّح وابحث عن ما يناسبك',    icon: BookOpen,     color: 'bg-primary/10 border-primary/20 text-primary' },
              ...
              <div className="text-center md:text-right flex-1">
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  <a href="https://www.facebook.com/Farouk1881" target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary hover:bg-blue-700 text-white text-sm font-medium shadow-md shadow-red-600/20 hover:shadow-lg transition-all duration-300">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-r from-primary/8 via-primary/3 to-primary/8" />
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/10 border border-primary/20 flex items-center justify-center mx-auto mb-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/register">
              <Button size="lg" className="gap-2 px-8 bg-primary text-white border-0 rounded-xl shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300">
